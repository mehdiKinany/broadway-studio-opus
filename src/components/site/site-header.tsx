...
export function SiteHeader() {
  ...
  return <header className={`site-header fixed inset-x-0 top-0 z-50 border-b ${scrolled || pathname !== "/" ? "is-compact border-hero-foreground/10 bg-surface-deep backdrop-blur-md" : "border-transparent bg-surface-deep/35"}`}>
    <div className="site-header-inner section-shell grid h-[5.5rem] grid-cols-[minmax(0,1fr)_auto] items-center gap-4 lg:grid-cols-[auto_minmax(0,1fr)_auto]">
