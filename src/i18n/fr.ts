export const fr = {
  ...
  galleryPage: {
    ...
    items: {
      "studio-exterieur": { alt: "Façade de Broadway Studio à Ville Verte, Bouskoura", caption: "Broadway Studio à Ville Verte" },
      "enseigne-lumineuse": { alt: "Enseigne lumineuse Broadway Studio dans les locaux de Ville Verte", caption: "L’enseigne Broadway Studio" },
      "studio-inscriptions": { alt: "Façade de Broadway Studio photographiée pour la campagne d’inscriptions 2025-2026", caption: "La façade du studio" },
      "portes-ouvertes": { alt: "Affiche officielle des Journées Portes Ouvertes Broadway Studio des 19 et 20 septembre 2026", caption: "Journées Portes Ouvertes 2026" },
      piano: { alt: "Enfant jouant sur un piano acoustique pendant un cours à Broadway Studio", caption: "Cours de piano acoustique" },
      guitare: { alt: "Deux élèves et leur professeur pendant un cours collectif de guitare dans la salle de musique", caption: "Cours collectif de guitare" },
      batterie: { alt: "Professeur installé à la batterie dans la salle de musique ornée du logo Broadway Studio", caption: "Cours de batterie" },
      danse: { alt: "Professeure accompagnant deux jeunes enfants pendant un cours d’éveil danse devant le logo Broadway Studio", caption: "Éveil danse" },
      "gym-sportive": { alt: "Enfants réalisant un exercice de gymnastique sportive sur le tatami avec leur professeur", caption: "Gymnastique sportive" },
      "gym-rythmique": { alt: "Jeunes gymnastes pratiquant avec des cerceaux dans une salle équipée de barres", caption: "Gymnastique rythmique" },
      judo: { alt: "Professeur et jeunes élèves de judo saluant sur le tatami Broadway Studio", caption: "Cours de judo" },
      "arts-martiaux": { alt: "Deux pratiquants en tenue blanche pendant un exercice sur un tapis jaune devant le logo Broadway Studio", caption: "Cours d’arts martiaux" },
      kickboxing: { alt: "Enfant travaillant un coup de pied de kick-boxing avec son coach", caption: "Cours de kick-boxing" },
      "theatre-scene": { alt: "Troupe d’enfants en costume jouant ensemble sur une scène de théâtre", caption: "Jeunes comédiens en représentation" },
      "theatre-spectacle": { alt: "Jeunes comédiens réunis sur scène sous des lumières colorées pendant un spectacle", caption: "Spectacle de théâtre" },
      "oeuvres-eleves": { alt: "Peintures de paysages réalisées par des élèves sur une table d’atelier", caption: "Peintures réalisées par les élèves" },
      "atelier-bd": { alt: "Affiche officielle de l’atelier Bandes Dessinées et Mangas encadré par JBARA", caption: "Atelier BD & Mangas" },
      "anniversaire-bulles": { alt: "Enfants assis devant Broadway Studio au milieu de bulles géantes", caption: "Animation de bulles géantes" },
      "anniversaire-assiettes": { alt: "Enfants peignant des assiettes autour d’une table pendant un anniversaire", caption: "Atelier peinture sur assiettes" },
      "anniversaire-tshirt": { alt: "T-shirt blanc personnalisé avec le prénom Maya et décoré de couleurs", caption: "T-shirt personnalisé" },
      "anniversaire-creatif": { alt: "Enfant participant à un atelier créatif autour d’une table pendant un anniversaire", caption: "Atelier créatif" },
      "anniversaire-decoration": { alt: "Décoration Happy Birthday et animation d’assiettes tournantes dans le studio", caption: "Décoration d’anniversaire au studio" },
    },
  },
  pages: {
